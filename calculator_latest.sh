...
VERSION_FILE="https://raw.githubusercontent.com/${REPO_OWNER}/${REPO_NAME}/main/version.info"
UPDATE_SCRIPT="https://raw.githubusercontent.com/${REPO_OWNER}/${REPO_NAME}/main/update.sh"
